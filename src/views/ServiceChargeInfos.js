...
class serviceChargeInfo extends Component {
    constructor(props) {           
       ...
       this.serviceNumber=this.serviceNumber.bind(this)
    }
    serviceNumber(data){
        this.setState({
            result:data
    ...
    componentDidMount() {
         window.serviceNumber=this.serviceNumber;
    }
    upGrade(){
    ...
    render() {
        let result=null;
        if(getPlane()){
          result=this.state.result?JSON.parse(this.state.result):false;
        }else{
          try {
        ...
        return (
          <div className="service-charge-info common-box">
              <Header titleSrc={require("../images/pic_withdraw_topbg_d.png")}/>
                    ...
                    <div className="main">
                         <div className="details pl-16 pr-16 fs-14 pt-18 pb-40">
                              ...
                              <div className="flex-justify-center mt-16">
                                   <button className="flex-justify-center flex-items-center fs-14 more" onClick={this.upGrade}>
                                        去提升海盗团等级
...
export default serviceChargeInfo;