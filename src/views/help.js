...
class Help extends Component {
    ...
    render() {
        ...
        let link=this.state.linkArr.map((item,index)=>{
        ...
        return (
            <div className="customer">
                <Header titleSrc={require("../images/ic_service.png")}/>
                <div className="content">
                    <div className="main flex-between flex-wrap pl-16 pr-16">
                        {link}
                    </div>
                    ...
                    <div className="mt-15 pl-16 pr-16 question-list fs-14">
                        {data[4].content.map((item,index)=>{
                            return(
                              <Link to={`/helpDetails/4/${index}`} key={index} className="flex-items-center pl-10 mb-4">
                                    {item.question}
                              </Link>
                            )
                     ...
                     <button className="contect-service fs-18 flex-items-center flex-justify-center">
                        <img src={require("../images/ic_service_contact.png")} alt=""/>
                        <span className="ml-6" onClick={this.contactService}>联系客服</span>
                    </button>
                </div>
